...
def extrapolate_beat_times(beat_times, n_extend=1):
    """Extrapolate beat times beyond the original range."""
...
class MidiTokenizer:
    ...
    def tokenize_note(self, idx, token_type):
        ...
        if rt == -1:
            raise ValueError(f"type {token_type} is not a predefined token type.")
        else:
            return rt
    ...
    def notes_to_tokens(self, notes):
        ...
        Args:
            notes: Array of (onset idx, offset idx, pitch, velocity)
        """
    ...
    def notes_to_relative_tokens(
        ...
        """Convert notes to relative tokens."""
    ...
    def relative_batch_tokens_to_midi(
        ...
        """Convert batch of relative tokens to MIDI."""
    ...
    def relative_tokens_to_notes(self, tokens, start_idx, cutoff_time_idx=None):
        """Convert relative tokens to notes."""
        # Handle composer token at the start
    ...
    def notes_to_midi(self, notes, beatstep, offset_sec=None):
        """Convert notes to PrettyMIDI object."""
